...
window.tagcloud = (function(win, doc) { // ns
    ...
    function TagCloud (options) {
        ...
        self.box.style.minHeight =  0.9 * self.size + "px";
    ...
    TagCloud.prototype = {
        ...
        update: function () {
            ...
            for (var j = 0, len = self.items.length; j < len; j++) {
                ...
                var colors = ['#FF9946','#788CF0','#FACF2A', '#F0938A', '#4CDFBF', '#FFC57F', '#5F73F3', '#63DBF2', '#2ECA93'];
                ...
                self.items[j].element.style.backgroundColor = colors[j] || '#FF9946';
            }
        },
